...
// Classe g�n�rique abstraite dont vont deriver les objets de la scene.
...
public:
    ...
    void setFrame(const qglviewer::Frame& frame) {
        frame_ = frame;
    }
    ...
    // Rayon d'une sph�re englobante (meme grossiere).
    //
...
private:
    ...
    bool animateTranslation(float time, qglviewer::Vec *v);
